...
#### Installation
```
git clone https://github.com/Funkycodes/AirBnB_clone
cd AirBnB_clone
```
#### Usage
Interactive Mode
...
* Language: Python3
* OS: Ubuntu 14.04 LTS
* Style guidelines: [PEP 8 (version 2.8)](https://www.python.org/dev/peps/pep-0008/) \|| [Google Style Python Docstrings](http://sphinxcontrib-napoleon.readthedocs.io/en/l\atest/example_google.html) || [WC3 Validator](https://github.com/holbertonschool/W3C-Validator)
